  ...
  "node_modules/bottleneck/light.js"(exports2, module2) {
    (function(global2, factory) {
      ...
      Events = class Events {
        ...
        _addListener(name2, status2, cb) {
          var base;
          if ((base = this._events)[name2] == null) {
            base[name2] = [];
          }
          this._events[name2].push({ cb, status: status2 });
...
var dist_bundle_exports2 = {};
__export(dist_bundle_exports2, {
...
var import_light2, VERSION2, noop, triggers_notification_paths_default, regex, triggersNotification, groups, createGroups;
...
// validateAnnotationsArray.js
var require_validateAnnotationsArray = __commonJS({
  "validateAnnotationsArray.js"(exports2) {
    function validateAnnotationsArray2(payload) {
      const errors = [];
      ...
      payload.forEach((item, index) => {
        ...
        if (item.start_column !== void 0 && (typeof item.start_column !== "number" || item.start_column < 1)) {
          errors.push(`Item at index ${index} has an invalid 'start_column'`);
        }
        if (item.end_column !== void 0 && (typeof item.end_column !== "number" || item.end_column < 1)) {
        ...
        if (item.raw_details !== void 0 && typeof item.raw_details !== "string") {
          errors.push(`Item at index ${index} has an invalid 'raw_details'`);
        }
      });
      return errors;
    }
    exports2.validateAnnotationsArray = validateAnnotationsArray2;
  }
});

// validateImagesArray.js
var require_validateImagesArray = __commonJS({
  "validateImagesArray.js"(exports2) {
    function validateImagesArray2(payload) {
      const errors = [];
      if (!Array.isArray(payload)) {
        errors.push("Payload is not an array");
        return errors;
      ...
      payload.forEach((item, index) => {
        ...
        if (!Object.prototype.hasOwnProperty.call(item, "alt") || typeof item.alt !== "string") {
          errors.push(`Item at index ${index} has an invalid 'alt'`);
        }
        if (!Object.prototype.hasOwnProperty.call(item, "image_url") || typeof item.image_url !== "string") {
          errors.push(`Item at index ${index} has an invalid 'image_url'`);
        }
        if (Object.prototype.hasOwnProperty.call(item, "caption") && typeof item.caption !== "string") {
          errors.push(`Item at index ${index} has an invalid 'caption'`);
        }
      });
      return errors;
    }
    exports2.validateImagesArray = validateImagesArray2;
  }
});

// index.js
var core = require("@actions/core");
var { context } = require("@actions/github");
var { GitHub } = require("@actions/github/lib/utils");
var { retry: retry2 } = (init_dist_bundle(), __toCommonJS(dist_bundle_exports));
var { throttling: throttling2 } = (init_dist_bundle2(), __toCommonJS(dist_bundle_exports2));
var { validateAnnotationsArray } = require_validateAnnotationsArray();
var { validateImagesArray } = require_validateImagesArray();
core.startGroup("setup variables and client");
var successStates = ["neutral", "success"];
...
var details = core.getInput("details");
var summary = core.getInput("summary");
var conclusion = core.getInput("conclusion");
var existingCheckRunId = core.getInput("check-run-id");
var images = core.getInput("images");
var annotations = core.getInput("annotations");
var token = core.getInput("github-token");
var OctokitWithPlugins = GitHub.plugin(retry2, throttling2);
console.log("created kit");
var octokit = new OctokitWithPlugins({
  auth: token,
...
var commitSha = "";
if (pull_request !== void 0) {
  commitSha = pull_request.head.sha;
}
if (commitSha == "" || commitSha === void 0) {
  core.warning("no pull request detected, using head sha");
  commitSha = context.sha;
}
var shouldFailForNeutral = core.getInput("fail-on-neutral");
...
var shouldFailForNonSuccess = core.getInput("fail-on-error");
...
async function run() {
  ...
  try {
    ...
    if (annotations) {
      ...
      const annotationValidationErrors = validateAnnotationsArray(annotationsAsJson);
